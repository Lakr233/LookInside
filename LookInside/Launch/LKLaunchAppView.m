...
- (void)setApp:(LKInspectableApp *)app {
    ...
    if (app.serverVersionError) {
        ...
        if (app.serverVersionError.code == LookinErrCode_ServerVersionTooLow) {
            ...
            self.errorTitleLabel.stringValue = app.serverVersionError.localizedDescription.length ? app.serverVersionError.localizedDescription : NSLocalizedString(@"Unable to inspect this app.", nil);
        }
