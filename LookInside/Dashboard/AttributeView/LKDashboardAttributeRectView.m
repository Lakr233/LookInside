...
- (void)controlTextDidEndEditing:(NSNotification *)notification {
    if (![self canEdit]) {
        // Read-only attribute (e.g. SwiftUI-injected user-custom rows have no
        // setter): AppKit can still post NSControlTextDidEndEditingNotification
        // when the field's superview is removed or its editable flag is
        // toggled, even though textShouldBeginEditing rejected user input.
        return;
    }
