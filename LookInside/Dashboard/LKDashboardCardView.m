...
- (void)handleRelationDocument {
    [LKHelper showDisabledExternalLinkAlertWithMessage:NSLocalizedString(@"Legacy member-variable documentation links are disabled in this community build. See the repository README instead.", nil)];
}
