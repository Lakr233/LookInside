        ...
        group.attrSections = [secIDs lookin_map:^id(NSUInteger idx, LookinAttrSectionIdentifier secID) {
            ...
            sec.attributes = [attrIDs lookin_map:^id(NSUInteger idx, LookinAttrIdentifier attrID) {
                ...
                if ([LookinDashboardBlueprint isUIViewPropertyWithAttrID:attrID]) {
                    ...
                    // Skip CALayer attributes when the backing layer's delegate
                    // doesn't match this view (e.g. NSRemoteView + NSVBCALayerHost).
                    // The backing layer is exposed as a separate child node.
                    CALayer *viewLayer = view.layer;
                    if (viewLayer && viewLayer.delegate != (id<CALayerDelegate>)view) {
                        return nil;
                    }
                    targetObj = viewLayer;
                }
